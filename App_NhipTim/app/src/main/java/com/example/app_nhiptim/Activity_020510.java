...
public class Activity_020510 extends AppCompatActivity {
    private ImageView imgStatus020510, imgAppStatus;
    private EditText edtMaNguoiBenh, edtTenNguoiBenh;
    private LineChart lineChart_BPM, lineChart_SPO2;
    private TextView txtBPM_020510_ct, txtSP02_020510_ct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_020510);
        // Ánh xạ
        imgStatus020510 = findViewById(R.id.imgStatus_020510);
        ...
        txtBPM_020510_ct = findViewById(R.id.txtBPM_020510_ct);
        txtSP02_020510_ct = findViewById(R.id.txtSPO2_020510_ct);
        ...
        sharedPreferences = getSharedPreferences("HistoryPrefs_0", MODE_PRIVATE);
        loadHistory();
        ...
        txtReset.setOnClickListener(v -> {
            ...
            new AlertDialog.Builder(Activity_020510.this)
                    .setTitle("Xác nhận")
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String maNguoiBenh_1 = edtMaNguoiBenh.getText().toString();
                String tenNguoiBenh_1 = edtTenNguoiBenh.getText().toString();

                // Tạo intent để chuyển dữ liệu sang MainActivity
                Intent intent = new Intent(Activity_020510.this, MainActivity.class);
                intent.putExtra("maNguoiBenh_1", maNguoiBenh_1);
                intent.putExtra("tenNguoiBenh_1", tenNguoiBenh_1);
        ...
        // hiển thị dữ liệu cũ lên lại edtMaNguoiBenh_1 và edt tenNguoiBenh_1
        ...
        edtMaNguoiBenh.setText(maNguoiBenh_1);
        edtTenNguoiBenh.setText(tenNguoiBenh_1);
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    Toast.makeText(Activity_020510.this, "Connected MQTT server", Toast.LENGTH_SHORT).show();
                    imgAppStatus.setBackgroundResource(R.drawable.connect);
                    SUB(client, "esp32_Max30102_020510");//thiết bị 020510
                    client.setCallback(new MqttCallback() {
                        @Override
                        public void connectionLost(Throwable cause) {
                            Toast.makeText(Activity_020510.this, "Mat ket noi Server", Toast.LENGTH_SHORT).show();
                        ...
                        public void messageArrived(String topic, MqttMessage message) throws Exception {
                            ...
                            if(topic.equals("esp32_Max30102_020510"))
                            {
                                try {
                                    ...
                                    runOnUiThread(() -> {
                                        txtBPM_020510_ct.setText(String.valueOf(bpm));
                                        txtSP02_020510_ct.setText(String.valueOf(spo2));

                                        // Cập nhật trạng thái thiết bị 020510 khi có dữ liệu
                                        imgStatus020510.setBackgroundResource(R.drawable.point_connect);
                                    });
...
//                    Toast.makeText(MainActivity.this, "that bai", Toast.LENGTH_SHORT).show();
    ...
    private void resetConnectionTimeout() {
        ...
        checkConnectionRunnable = () -> {
            ...
            imgStatus020510.setBackgroundResource(R.drawable.point_disconnect);
            // Đặt lại giá trị của txtBPM_020510 và txtSPO2_020510 về "NaN"
            runOnUiThread(() -> {
                txtBPM_020510_ct.setText("NaN");
                txtSP02_020510_ct.setText("NaN");
            });
        };
        ...
        handler_chart_BPM.postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String bpmText = txtBPM_020510_ct.getText().toString();
                    ...
                    Log.e("Activity_020510", "Invalid BPM data: " + txtBPM_020510_ct.getText());
                }
    ...
    private void startUpdating_SPO2() {
        handler_chart_SPO2.postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    // Lấy giá trị từ TextView và chuyển thành số
                    String SPO2Text = txtSP02_020510_ct.getText().toString();
                    ...
                    // Trường hợp không chuyển đổi được (có thể là NaN hoặc dữ liệu không hợp lệ)
                    Log.e("Activity_020510", "Invalid SPO2 data: " + txtSP02_020510_ct.getText());
                }

                // Gọi lại phương thức này sau 5 giây
    ...
    private void saveData() {
        String bpmValue = txtBPM_020510_ct.getText().toString();
        String spo2Value = txtSP02_020510_ct.getText().toString();
